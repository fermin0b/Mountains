...
namespace AmplifyAnimationPack
{
    ...
    public class TextureScroller : MonoBehaviour
    {
        ...
        void Update()
        {
            textureOffset += Time.deltaTime * 0.05f;
            mat.SetTextureOffset( "_MainTex" , -Vector2.up * textureOffset );
            mat.SetTextureOffset( "_MetallicGlossMap" , -Vector2.right * textureOffset );
            mat.SetTextureOffset( "_DetailAlbedoMap" , -Vector2.right * textureOffset );
            mat.SetTextureOffset( "_DetailNormalMap" , -Vector2.right * textureOffset );
